...
function loadData()
{
  ...
  $("#phone").val($("#ephone").val());
  $("#city").val($("#ecity").val());
  $("#address").val($("#eaddress").val());
  $("#company").val($("#epcompany").val());
    ...
    function (isConfirm) {
        if (isConfirm) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: { pid:$('#pid').html(),pname:$('#epname').val(),punit:$('#punit').val(),prate:$('#prate').val() },
                success: function (msg) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                $.ajax({
                    ...
                    type: "POST",
                    data: { id: $('#payid').html(),amount:$('#ppaid').val(),type:$('#pptype').val(),detail:$('#ppdetail').val() },
                    success: function (msg) {
                          // alert(msg);
                        swal({
                            title: "Data Updated!",
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    data:{vid:$('#empid').val(),amount:$('#pamount').val(),date:$('#paymentDate').val(),detail:$('#pdetail').val(),type:$('#ptype').val()},
                    success: function(msg){
                         // alert(msg);
                    }
                });
