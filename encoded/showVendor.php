        ...
        <div class="col-md-10 col-md-offset-1" style="padding-right:1px; padding-left:0px;">
            <div class="panel panel-info" style="margin-top:10px;">
                <div class="panel-heading">
                    ...
                    <a onclick="deleteEmployee(<?php echo $eid; ?>)" class="btn btn-md btn-danger" style="float:right; margin-top:25px; margin-bottom:5px;"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                    <a class="btn btn-md btn-primary" onclick="loadData();" data-toggle="modal" data-target="#editEmployeeModal" style="float:right; margin-top:25px; margin-bottom:5px; margin-right:5px;"><i class="fa fa-edit"></i>&nbsp;Edit</a> <?php }?>
                    ...
                    <div class="row">
                        <div class="col-md-8" style="padding-right: 0px;">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:10px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i>&nbsp;Name</span>
                                            <input name="etname" id="etname" type="text" class="form-control" value="<?php echo $name; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="padding-top:10px; padding-left:10px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-credit-card"></i>&nbsp;NIC</span>
                                            <input name="enic" id="enic" type="text" class="form-control" value="<?php echo $nic; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:10px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            ...
                                            <input name="eemail" id="eemail" type="email" class="form-control" value="<?php echo $email; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="padding-top:10px; padding-left:10px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-phone"></i>&nbsp;Phone</span>
                                            <input name="ephone" id="ephone" type="text" class="form-control" value="<?php echo $phone; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:10px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            ...
                                            <input name="ecompany" id="ecompany" type="text" class="form-control" value="<?php echo $company; ?>"
                                                   readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="padding-top:10px; padding-left:10px; padding-right:0px;">
                                        <div class="input-group">
                                            ...
                                            <input name="ecity" id="ecity" type="text" class="form-control" value="<?php echo $city; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="padding-top:10px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            ...
                                            <textarea name="eaddress" id="eaddress" type="text" class="form-control" rows="2" cols="5" readonly><?php echo $address; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6" style="padding-left:0px; padding-top:10px;">
                                        <div class="input-group">
                                            ...
                                            <input name="eopening_balance" id="eopening_balance" type="text" class="form-control" value="<?php echo 'RS '. number_format($opening_balance,2); ?>" readonly />
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="padding:0px; padding-top:10px;">
                                        <div class="input-group">
                                            ...
                                            <input name="payment" id="payment" type="text" class="form-control" value="<?php echo 'RS '. number_format($pendingpayment,2); ?>" readonly />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="radvance" id="radvance" type="text" class="form-control" value='<?php echo $radvance;?>' readonly>
                            </div>
                        </div>
                                                    <div class="form-group">
                            <div class="input-group">
...
<div class="row" style="margin-top:10px;">
    <div class="col-md-6" style="padding:0px;">
        ...
        <div class="input-group">
                ...
                <input id="fdate" type="text" placeholder="click to select date" class="form-control" onchange="filterPurchase();">
                <span class="input-group-addon">  to</span>
                <input id="tdate" type="text" placeholder="click to select date" class="form-control" onchange="filterPurchase();">
            </div>
        </div>
...
<div class="modal fade" id="editEmployeeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:20px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <input id="eaid" name="eaid" style="display: none;" value="<?php echo $eid; ?>">
                                            <span class="input-group-addon"><i class="fa fa-user"></i>&nbsp;Name</span>
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:20px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-global"></i>&nbsp;Email</span>
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="padding-top:10px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-home"></i>&nbsp;Company Name</span>
                                            <input name="company" id="company" type="text" class="form-control"  readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="padding-top:10px; padding-left:10px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-building"></i>&nbsp;City</span>
                                            <select id="city" name="city" class="form-control"  onchange="filter();">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="padding-top:20px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-book"></i>&nbsp;Address</span>
                                            <textarea name="address" id="address" type="text" class="form-control" rows="2" cols="5" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12" style="padding-top:20px; padding-left:0px; padding-right:0px;">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Opening Balance</span>
                                            <input name="opening_balance" id="opening_balance" type="text" class="form-control" value="<?php
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body notification-panel">
                                    <img class="img-responsive" id="preview" src="img/img.jpg" style="height:180px; width:240px;" />
                                    <input tabindex="-1" style="margin-top:10px; margin-left:7px; width:95%;" class="btn btn-primary btn-sm" name="uimage" id="uimage" type="file" onchange="PreviewImage();" />
...
<div class="modal fade" id="advanceSheet" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            ...
            <div class="modal-body well">
                <div class="row">
                    <div class="input-group">
                        ...
                        <input id="adate" type="text" class="form-control" placeholder="click to select date" onchange="filterAdvance();">
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-top:20px;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo "RS ".number_format($pendingadvance+$paidadvance,2); ?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Total Advance Recieved</span>
                        <input type="text" class="form-control" value="<?php echo "RS ".number_format($paidadvance,2); ?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Total Advance Pending</span>
                        <input type="text" class="form-control" value="<?php echo "RS ".number_format($pendingadvance,2); ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body well">
                ...
                <div class="row" style="padding-top:20px;">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo "RS ".number_format($pendingpayment,2); ?>" readonly>
                    </div>
                    </div>
                    <div class="col-md-6" style="padding-left:0px">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Total Amount Paid</span>
                        <input type="text" class="form-control" value="<?php echo "RS ".number_format($paidAmount,2); ?>" readonly>
                    </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div style="padding-left:0px;" >
                        <center><button class="btn btn-md btn-danger" type="button" style="margin-top:2%;" onclick="paymentPay();" ><i class="fa
                        fa-plus"></i>&nbsp;
                            Add  Enrty</button></center>
                    </div>
                </div>
...
<div class="modal fade" id="editrow" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
 ...
 <div class="modal-header" style="padding: 5px;">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-briefcase fa-1x" tabindex="-1"></i>&nbsp;Edit Item no:&nbsp;<span id="pid" style="color:red"></span>&nbsp;of&nbsp;Date:&nbsp;<span style="color:blue" id="epdate"></span></h4>
            </div>
            <form>
                <div class="modal-body well">
                        ...
                        <div class="panel panel-success" style="margin:0px;">
                            ...
                            <div class="panel-body" style=" padding:0px;">
                                <table class="table table-bordered table-hover ab" style="padding:0px; margin-bottom: 0px;">
                                    ...
                                    <tbody><form>
                                    <td>
                                        <select id="epname" class="form-control"  placeholder='Select Product...' tabindex="1">
                                            <?php
                                                $result=query( "select p.des from product p;"); while($row=mysqli_fetch_array($result)) { echo '<option>'.$row[ 'des']. '</option>'; }
                                            ?>
                                        </select>
                                    </td>
                                    <td>
                                        <input class="form-control" type="number" placeholder="@" id="prate" tabindex="2" />
                                    </td>
                                    <td>
                                        <input class="form-control" type="number" placeholder="Unit" id="punit" tabindex="3" />
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-md btn-warning" onclick="saveE();" tabindex="4"><i class="fa fa-edit"></i>&nbsp;Update Entry</button>
                                    </td>
            </form>
            </tbody>
...
<div class="modal fade" id="editAdrow" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
 <div class="modal-header" style="padding: 5px;">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-money fa-1x" tabindex="-1"></i>&nbsp;Edit Advance no:&nbsp;<span id="adid" style="color:red"></span>&nbsp;of&nbsp;Date:&nbsp;<span style="color:blue" id="addate"></span></h4>
            </div>
            <form>
                <div class="modal-body well">
                        ...
                        <div class="panel panel-success" style="margin:0px;">
                            ...
                            <div class="panel-body" style=" padding:0px;">
                                <table class="table table-bordered table-hover ab" style="padding:0px; margin-bottom: 0px;">
                                    ...
                                    <tbody><form>
                                    <td>
                                        <input class="form-control" type="text" placeholder="Advance Paid" id="adad" tabindex="1" />
                                    </td>
                                    <td>
                                        <input class="form-control" type="number" placeholder="Advance Deduct" id="addad" tabindex="2" />
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-md btn-warning" onclick="editA();" tabindex="3"><i class="fa fa-edit"></i>&nbsp;Update Entry</button>
                                    </td>
            </form>
            </tbody>
...
<div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal" tabindex="4"><i class="fa fa-remove"></i>&nbsp;Close</button>
                        ...
                        <div class="panel panel-success" style="margin:0px;">
                            ...
                            <div class="panel-body" style=" padding:0px;">
                                <table class="table table-bordered table-hover ab" style="padding:0px; margin-bottom: 0px;">
                                    ...
                                    <tbody><form>
                                        <td>
                                            <input class="form-control" type="text" placeholder="Payment Paid" id="ppaid" tabindex="1" />
                                        </td>
                                        <td>
