                    ...
                    <?php } ?> >
                        <a href="index.php?page=wcustomers">
                            <i class="fa fa-map-signs fa-5x" style="font-size:18px;">
                                <b style="margin-left:0px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">&nbsp;&nbsp;Walk In Cus</b>
                            </i>
                        </a>
                    </li>
                    ...
                    <li <?php if($page=="logout" ) { ?> class="active"
                        <?php } ?> >
                            <a href="index.php?page=logout">
                              ...
                              <b style="margin-left:10px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Log out</b>
                            </i>
                            </a>
                    </li>
