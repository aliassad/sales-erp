        ...
        <div class="panel panel-info" style="margin-top:10px;">
            ...
            <div class="panel-body">
                <table class="table table-bordered" style="padding:0px;">
                    ...
                    <tr>
                        <td class="nocenter" colspan="2"><i class="fa fa-book"></i>&nbsp;<b>Address:</b><span id="address"><?php echo
                                $address;
                                ?></span></td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered" style="padding:0px;margin-top:5px;">
                    ...
                    <tr>
                        <td class="nocenter"><i class="fa fa-money"></i>&nbsp;<b>Total Amount:</b>
                            <?php echo "RS " . number_format($tamount+$charge, 2); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="nocenter"><i class="fa fa-money"></i>&nbsp;<b>Total Amount Recieved:</b>
                            <?php echo "RS " . number_format($tpaid+$amountReceived, 2); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="nocenter"><i class="fa fa-money"></i>&nbsp;<b>Total Balance:</b>
                            <?php echo "RS " . number_format($tbalance, 2); ?>
                        </td>
                    </tr>
                        ...
                        <div class="form-group" style="padding-top:10px;">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="ccompany" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-building"></i>&nbsp;City</span>
                                    <select id="ccity" name="ccity" class="form-control">
                ...
                <div class="row" style="padding-top:20px;">
                    <div class="col-md-6" style="padding-left:0px">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo "RS " . number_format($tpaid+$amountReceived, 2); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6" style="padding-left:0px">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Total Amount Balance</span>
                            <input type="text" class="form-control" value="<?php echo "RS " . number_format($tbalance, 2); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
