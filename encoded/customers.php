<div class="container-fluid">
    <div class="page-content">
        ...
        <div class="col-md-6" style="margin-bottom:10px; padding:5px;">
            ...
            <a href="index.php?page=sell" class="btn btn-md btn-primary" style="float:right;margin-top:5px; margin-right:5px;">
                <i class="fa fa-shopping-cart"></i>&nbsp;Selling</a>
                <a href="index.php?page=stock" class="btn btn-md btn-warning" style="float:right;margin-top:5px; margin-right:5px;">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-md-4" style="padding:0px;">
                ...
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-search"></i>&nbsp;Customer ID#</span>
            ...
            <div class="col-md-4" style="padding-left:5px; padding-right:0px;">
                <div class="input-group">
                    ...
                    <select id="pcity" class="selectpicker show-tick" data-live-search="true" title='Select City...' onchange="filter();">
                        <option class="btn-success">Show all</option>
                        <?php
                    ...
                    <table class="table table-bordered table-hover" style="padding:0px;">
                        ...
                        <tr>
                            <th class="text-center">
                                <i class="fa fa-pencil"></i>&nbsp;Customer Id#
                            </th>
                            <th class="text-center">
                ...
                <div class="col-lg-6 col-lg-offset-6" style="padding:0; ">
                    <table class="table" style="margin:0px;">
                        ...
                        <tr>
                            <td>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-money"></i>&nbsp;Total Amount Receivable (PKR):</span>
                                    <input type="text" id="total_Receivable" style="font-size:18px; font-weight: bold; " class="form-control" value="0" readonly
                                           tabindex="-1">
                                </div>
                            </td>
                        </tr>
                        ...
                        <div class="form-group" style="padding-top: 10px;">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <select id="ccity" name="ccity" class="selectpicker show-tick" data-live-search="true" title='Select
                                            City...' >
                                        <?php
                                        $result=query("select name from cities order by name");
                                        while($row=mysqli_fetch_array($result))
                        ...
                        <div class="form-group" style="padding-top: 10px;">
                            <div class="col-md-12">
                                <div class="input-group">
                                    ...
                                    <textarea id="caddress" type="text" class="form-control" rows="2" cols="5"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
