...
$result = query("select concat(id,': ',name) as name,gst from customer where id='$cid'");
while ($row = mysqli_fetch_array($result)) {
    $name = $row['name'];
    ...
    <div class="page-content">
        ...
        <div class="row" style="padding-bottom: 15px;">
            <div class="btn-group btn-breadcrumb">
                ...
                <?php }
                if (isset($_GET["cid"])) { ?>
                    <a href="index.php?page=showBill&billno=<?php echo $billno; ?>&cid=<?php echo $cid; ?>"
                       class="btn btn-default">
                        <i class="fa fa-file-text"></i>&nbsp;Bill</a>
                <?php } else { ?>
                    <a href="index.php?page=showBill&billno=<?php echo $billno; ?>" class="btn btn-default"><i
        ...
        <div class="row">
            <div class="col-md-4" style="padding: 0px;">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <select id="cuname" class="selectpicker show-tick" data-live-search="true" readonly disabled>
                            <option>
                                <?php echo $name; ?>
                            </option>
                            <?php
            ...
            <a class="btn btn-md btn-primary" onclick="saveInvoice();" style="float:right;"> <i class="fa fa-edit"></i>&nbsp;Update
                &amp; Save</a>
        </div>
            ...
            <div class="col-md-7" style="padding:0px; margin:0px;">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" placeholder="click to select date" class="form-control" id="ddate"
                               value="<?php echo $date; ?>"/>
        ...
        <div class="panel panel-primary" style="margin-bottom: 10px;">
            ...
            <div class="panel-footer clearfix" style="padding-top: 0px; padding-bottom: 0px; margin: 0px;">
                <table class="table" style="margin: 0px;">
                    ...
                    <th>GST (<span id="invoice_gst"><?= $customer_gst ?></span>)%:</th>
