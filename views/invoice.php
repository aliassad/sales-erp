...
<div class="container-fluid">
    <div class="page-content">
            ...
            <div class="col-md-3" style="padding: 0px; ">
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <?php
                        $result = query("select id, gst from customer");
                        while ($row = mysqli_fetch_array($result)) {
                            echo '<span id="customer_' . $row['id'] . '" style="display:none;">' . $row['gst'] . '</span>';
                        }
                        ?>
                        <select id="cuname" class="selectpicker show-tick" name="cunane" data-live-search="true"
                                title='Select Customer...' onchange="loadGST();">
                            <?php
        ...
        <div class="row" style="padding-bottom:5px;">
            ...
            <div class="col-md-4" style="padding-left:0px">
                <div class="input-group">
                    <span class="input-group-addon" style="background-color:#2D89EF; color: #FFFFFF;"><i
                                class="fa fa-credit-card"></i>&nbsp;Member Ship No:</span>
                    <select class="selectpicker show-tick" id="mcno" name="mcno" data-live-search="true"
                            title='Select Member...'>
